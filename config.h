...
static const char *light_up[] = {"/usr/bin/light", "-A" , "20"};
static const char *light_down[] = {"/usr/bin/light", "-U" , "20"};
...
static const char *fonts[] = {  
  ...
  "Noto Sans Mono CJK SC:style:Medium:size=13",
};
...
static const Key keys[] = {
    ...
    {ControlMask, XK_m,             spawn, {.v = mutevol}}, 
    {ControlMask, XK_Up,            spawn, {.v = upvol}}, 
    {ControlMask, XK_Right,         spawn, {.v = light_up}}, 
    {ControlMask, XK_Left,          spawn, {.v = light_down}}, 

    // screenshot fullscreen and cropped
    { MODKEY,                           XK_c,       spawn,          SHCMD("launcher &") }, 
    { MODKEY,                           XK_Escape,  spawn,          SHCMD("powermenu &") },
    { MODKEY,                           XK_Return,  spawn,          SHCMD("st &")},
    
    { MODKEY,                           XK_g,       spawn,          SHCMD("chromium &")},
    { MODKEY,                           XK_n,       spawn,          SHCMD("st -e newsboat")},
    { MODKEY|ShiftMask,                 XK_n,       spawn,          SHCMD("st -e neomutt")},
    ...
    { MODKEY,			                      XK_backslash,		    spawn,		      SHCMD( "mpv --untimed --no-cache --no-osc --no-input-default-bindings --profile=low-latency --input-conf=/dev/null --title=webcam $(ls /dev/video[0,2,4,6,8] | tail -n 1)" ) },
    ...
    // open bookmarks
    { MODKEY|ShiftMask,                 XK_equal,   spawn,          SHCMD( "bookmark" ) },
    { MODKEY,                           XK_equal,   spawn,          SHCMD( "xdotool type $(grep -v '^#' ~/.local/share/bookmarks | rofi -dmenu -i -l 25 -theme $HOME/.config/rofi/launchers/type-4/style-2.rasi | cut -d' ' -f1)") },
...
static const Button buttons[] = {
    ...
    /* Keep movemouse? */
    { ClkClientWin,         MODKEY,         Button1,        movemouse,      {1} },
